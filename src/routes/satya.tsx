...
import satya from "@/assets/subtheme/satya.jpeg";

export const Route = createFileRoute("/satya")({
  component: SatyaPage,
  head: () => ({
    meta: [
      { title: "Satya — Cita Loka Audio Story" },
      {
        name: "description",
        content:
          "Dengarkan petualangan Satya — cerita audio interaktif tentang pangan lokal Indonesia untuk anak.",
      },
    ],
  }),
});
...
const stories: Story[] = [
  { num: "01", title: "Satya: Bahasa Indonesia", duration: "0:37" },
  { num: "02", title: "Satya: Bahasa Inggris", duration: "0:37" },
  { num: "03", title: "Satya: Bahasa Daerah", duration: "0:37" },
];
      ...
      <div className="mx-auto w-full max-w-md lg:max-w-6xl md:rounded-[32px] md:bg-white md:shadow-[0_10px_40px_rgba(0,0,0,0.06)] px-5 pb-16 pt-8 md:py-10">
        ...
        <section className="mt-6">
          <p
            ...
            style={{ color: BG }}
          >
            Satya • Si Anak Penjual
          </p>
          <h1 className="mt-2 font-display text-[30px] leading-[1.05] text-foreground">
            Satya
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Satya seorang anak laki-laki dengan warna kulitnya begitu eksotis dengan rambut ikal menjadi ciri khasnya. Ia suka sekali dengan pasar,  bukan karena apa tapi Satya terbiasa oleh aktivitas Ibunya yang berjualan bahan pokok di pasar. Logat yang cepat dengan bahasa papua menjadi ciri khas Satya dan Ibunya.
          </p>
