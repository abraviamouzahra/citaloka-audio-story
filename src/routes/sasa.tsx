...
const stories: Story[] = [
  { num: "01", title: "Sasa: Bahasa Indonesia", duration: "0:37" },
  { num: "02", title: "Sasa: Bahasa Inggris", duration: "0:37" },
  { num: "03", title: "Sasa: Bahasa Daerah", duration: "0:37" },
];
