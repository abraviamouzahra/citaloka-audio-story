...
import sasa from "@/assets/subtheme/sasa-temp.png";
  ...
  head: () => ({
    meta: [
      { title: "Sasa — Cita Loka Audio Story" },
      {
        name: "description",
        content:
          "Dengarkan petualangan Sasa — cerita audio interaktif tentang pangan lokal Indonesia untuk anak.",
      },
    ],
  }),
});
...
const stories: Story[] = [
  { num: "01", title: "Sasa Indonesia", duration: "0:37" },
  { num: "02", title: "Sasa English", duration: "0:37" },
  { num: "03", title: "Sasa Daerah", duration: "0:37" },
];
      ...
      <div className="mx-auto w-full max-w-md lg:max-w-6xl md:rounded-[32px] md:bg-white md:shadow-[0_10px_40px_rgba(0,0,0,0.06)] px-5 pb-16 pt-8 md:py-10">
        ...
        <section className="mt-6">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Gadis bali yang sangat mengagumi kekayaan negeri dengan selalu bersyukur atas nikmat yang dirasakan. Warna kulit yang berbeda dengan pakaian yang mencolok menjadi khas tersendiri baginya.
          </p>
